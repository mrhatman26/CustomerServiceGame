...
try{
	...
	if (queue_pos_updated == false){
		if (mouse_overlaps_me(x, y, spr_customers, size_increase) && my_queue_pos == 0){
			draw_sprite_ext(spr_customers_outline, my_body, x, y, image_xscale * size_increase, image_yscale * size_increase, 0, c_white, 1);
		}
	}
}
//Error drawing
	...
	if (queue_pos_updated == false){
		if (mouse_overlaps_me(x, y, spr_customers, size_increase) && my_queue_pos == 0){
			draw_sprite_ext(spr_customers_outline, 0, x, y, image_xscale * size_increase, image_yscale * size_increase, 0, c_white, 1);
		}
	}
